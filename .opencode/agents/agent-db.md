---
description: Especialista exclusivo en src/db/database.js (sql.js, FTS4, schema, migraciones, persistencia SQLite). Invocar para cambios de esquema, queries, triggers FTS, o cualquier modificación de la capa de datos.
mode: subagent
permission:
  edit:
    "src/db/**": allow
